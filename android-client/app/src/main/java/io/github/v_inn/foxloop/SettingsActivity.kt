...
import io.github.v_inn.foxloop.ui.FoxLoopTokens
import io.github.v_inn.foxloop.ui.SettingsScreen
import io.github.v_inn.foxloop.ui.SettingsScreenState
...
class SettingsActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // over it in graphite.
        window.setBackgroundDrawable(ColorDrawable(FoxLoopTokens.Slate.toArgb()))
        hideSystemBars()
