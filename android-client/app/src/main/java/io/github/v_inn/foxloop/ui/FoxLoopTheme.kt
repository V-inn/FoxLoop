 ...
 * [foxloopSpring] / [foxloopTween] rather than calling `spring()` directly.
 */
...
@Composable
fun FoxLoopTheme(sessionLive: Boolean = false, content: @Composable () -> Unit) {
...
@Composable
fun <T> foxloopTween(durationMillis: Int = 140): AnimationSpec<T> =
