package io.github.v_inn.foxloop
 ...
 *   evidence a FoxLoop daemon is on the other end of the cable, and its absence
...
object ConnectionStatus {
    ...
    const val PROJECT_URL = "github.com/V-inn/FoxLoop"
    ...
    fun message(
        ...
        val body = when {
            ...
            silentHandshakes >= SILENT_HANDSHAKES_BEFORE_BLAMING_THE_DAEMON ->
                "This computer's FoxLoop daemon is not answering.\n" +
            ...
            !everConnected && !accessoryPresent && !debugTransport ->
                "FoxLoop needs its other half.\n\n" +
                    "This tablet is the screen. The desktop comes from a Linux " +
                    "computer\nrunning the FoxLoop daemon, reached over the USB cable.\n\n" +
            ...
            accessoryPresent ->
                ...
                "Waiting for connection...\n" +
                    "Plug this tablet into the computer running the FoxLoop daemon." +
